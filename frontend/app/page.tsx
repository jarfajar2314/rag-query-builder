    ...
    <main className="min-h-screen bg-gray-50 text-gray-900 p-8 font-sans">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-blue-700 mb-2">RAG Query Builder</h1>
          <p className="text-gray-500">Ask natural language questions about your database</p>
        </div>
        ...
        {response && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Debugging section */}
            <div className="pt-8">
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider mb-4 border-b border-gray-200 pb-2">Developer Tools</h3>
